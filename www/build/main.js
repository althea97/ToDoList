    ...
    HomePage.prototype.addTask = function () {
        ...
        if (this.task != "") {
            ...
            if (btnValue == "addBTN") {
                ...
                var index = document.getElementById('taskName').value; // gets task index from input value
                if (index > -1) {
